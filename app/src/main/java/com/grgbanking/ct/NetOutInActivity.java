...
//		startService(new Intent(context, GrgbankService.class));
        ...
        sysOutImageView=(ImageView) findViewById(R.id.net_sysout_view);
        sysOutImageView.setOnClickListener(saomiaoButtonclick);
        
        netInButton = (Button) findViewById(R.id.net_in_button);
